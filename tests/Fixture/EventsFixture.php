...
class EventsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'interval_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'last_update' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        'last_error' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
...
'engine' => 'InnoDB', 'collation' => 'utf8_general_ci'
    ...
    public $records = [
        [
            ...
            'source_id' => 1,
            'interval_id' => 1,
            'last_update' => '2015-04-14 01:10:53',
            'last_error' => 'Lorem ipsum dolor sit amet',
            'created' => '2015-04-14 01:10:53',
            'modified' => '2015-04-14'
        ],
    ];
}
