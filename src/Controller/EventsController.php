...
class EventsController extends AppController
{
    ...
    public function view($id = null)
    {
        $event = $this->Events->get($id, [
            'contain' => ['Sources', 'Intervals', 'Leagues']
        ]);
    ...
    public function add()
    {
        ...
        $sources = $this->Events->Sources->find('list', ['limit' => 200]);
        $intervals = $this->Events->Intervals->find('list', ['limit' => 200]);
        $this->set(compact('event', 'sources', 'intervals'));
        $this->set('_serialize', ['event']);
    }
